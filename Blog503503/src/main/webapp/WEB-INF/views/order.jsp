...
<div class="wrapper">
	<div class="wrap">
		...
		<div class="content_area">
			...
			<div class="content_subject"><span>장바구니</span>
					...
					<table class="table_text_align_center memberInfo_table">
						<tbody>
							<tr>
								...
								<td style="width: *">${memberInfo.memberrName} | ${memberInfo.memberrMail}</td>
							</tr>
						</tbody>
					</table>
				</div>
			...
			<tbody>
				<tr>
					<th>이름</th>
					<td>
						${memberInfo.memberrName}
					</td>
				</tr>
				<tr>
					<th>주소</th>
					<td>
						${memberInfo.memberrAddr1} ${memberInfo.memberrAddr2}<br>${memberInfo.memberrAddr3}	
						<input class="selectAddress" value="T" type="hidden">
						<input class="addressee_input" value="${memberInfo.memberrName}" type="hidden">
						<input class="address1_input" type="hidden" value="${memberInfo.memberrAddr1}">
						<input class="address2_input" type="hidden" value="${memberInfo.memberrAddr2}">
						<input class="address3_input" type="hidden" value="${memberInfo.memberrAddr3}">									
					</td>
				</tr>
			</tbody>
		</table>
		...
		<form class="order_form" action="/order" method="post">
			<!-- 주문자 회원번호 -->
			<input name="memberrId" value="${memberInfo.memberrId}" type="hidden">
			<!-- 주소록 & 받는이-->
			<input name="addressee" type="hidden">
			<input name="memberrAddr1" type="hidden">
			<input name="memberrAddr2" type="hidden">
			<input name="memberrAddr3" type="hidden">
			<!-- 사용 포인트 -->
...
$(".order_btn").on("click", function(){
	...
	$(".addressInfo_input_div").each(function(i, obj){
		if($(obj).find(".selectAddress").val() === 'T'){
			...
			$("input[name='memberrAddr1']").val($(obj).find(".address1_input").val());
			$("input[name='memberrAddr2']").val($(obj).find(".address2_input").val());
			$("input[name='memberrAddr3']").val($(obj).find(".address3_input").val());
		}
	});	
