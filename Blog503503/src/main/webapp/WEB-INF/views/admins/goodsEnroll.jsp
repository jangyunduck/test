...
<link rel="stylesheet" href="../resources/css/admins/goodsEnroll.css">
...
<body>
	...
	<%@include file="../includes/admins/header.jsp" %>
                <div class="admin_content_wrap">
                    <div class="admin_content_subject"><span>상품 등록</span></div>
                    	...
                    	<form action="/admins/goodsEnroll" method="post" id="enrollForm">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
									...
									<div id="uploadResult">
									<!-- <div class="imgDeleteBtn">x</div> --><!-- 이줄이 있으면 사진삭제가 안된다. -->
 ...
 <script>
 	...
 	$("#cancelBtn").click(function(){
 		...
 		location.href="/admins/goodsManage"
 	});
