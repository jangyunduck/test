...
<link rel="stylesheet" href="../resources/css/admins/authorModify.css">
...
<body>
                ...
                <div class="admin_content_wrap">
                    ...
                    <div class="admin_content_main">
                    	<form id="modifyForm" action="/admins/authorModify" method="post">
...
$("#deleteBtn").on("click", function(e){
	...
	moveForm.attr("action", "/admins/authorDelete");
