...
<link rel="stylesheet" href="../resources/css/admins/authorManage.css">
...
<body>
    ...
    <%@include file="../includes/admins/header.jsp" %>
                <div class="admin_content_wrap">
                    ...
                    <div class="search_wrap">
                    	<form id="searchForm" action="/admins/authorManage" method="get">
                    ...
                    <form id="moveForm" action="/admins/authorManage" method="get">
 ...
 $(document).ready(function(){
	...
	// let result = "${enroll_result}";
	 ...
	 function checkResult(result){
		 ...
		 alert("작가'${enroll_result}' 을 등록 하였습니다.");
 ...
 $(".pageMaker_btn a").on("click", function(e){
     ...
     moveForm.submit();//다음페이지가 떠오르지 않을때는 자바스크립트 부분을 확인하라
 ...
 /* 작거 검색 버튼 동작 */
	...
	$(".move").on("click", function(e){
		...
		moveForm.attr("action", "/admins/authorDetail");
		moveForm.submit();
