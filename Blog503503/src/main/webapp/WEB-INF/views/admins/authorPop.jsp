...
<link rel="stylesheet" href="../resources/css/admins/authorPop.css">
<script
		...
		<div class="content_wrap">
				...
				<div class="author_table_wrap">
                    ...
                    <div class="search_wrap">
                    	<form id="searchForm" action="/admins/authorPop" method="get">
					...
					<form id="moveForm" action="/admins/authorPop" method="get">
