...
<link rel="stylesheet" href="../resources/css/admins/goodsModify.css">
	...
	<%@include file="../includes/admins/header.jsp" %>
	   ...
	   <div class="admin_content_wrap">
                    ...
                    <div class="admin_content_main">
                    	<form action="/admins/goodsModify" method="post" id="modifyForm">
	...
	<script>
		...
		$.getJSON("/getAttachList", {bookId : bookId}, function(arr){
			...
			if(arr.length === 0){
				...
				str += "<img src='/resources/img/book.jpg'>";
				str += "</div>";
...
/* 할인율 Input 설정 */
	...
	$("#deleteBtn").on("click", function(e){
		...
		moveForm.attr("action", "/admins/goodsDelete");
