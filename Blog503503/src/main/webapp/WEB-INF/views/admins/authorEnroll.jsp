...
<link rel="stylesheet" href="../resources/css/admins/authorEnroll.css">
...
<body>
                ...
                <div class="admin_content_wrap">
                    <div class="admin_content_subject"><span>작가 등록</span></div>
                     ...
                     <div class="admin_content_main">
                    	<form action="/admins/authorEnroll.do" method="post" id="enrollForm">
 ...
 $("#cancelBtn").click(function(){
	 	location.href="/admins/authorManage"
 });
